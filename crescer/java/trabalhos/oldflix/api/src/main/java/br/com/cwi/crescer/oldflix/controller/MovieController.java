...
public class MovieController {
    ...
    public RentMovieResponse rent(@RequestBody RentMovieRequest request, @PathVariable Long id){

        return movieService.rent(id,request);
    }

    @PutMapping("/{id}/devolver")
    public DevolutionMovieResponse devolution(@RequestBody DevolutionMovieRequest request, @PathVariable Long id){
        return movieService.devolution(id,request);
    }
    @PutMapping("/{id}")
    public ChangeMovieByIdResponse changeMovie (@RequestBody ChangeMovieByIdRequest request, @PathVariable Long id){
